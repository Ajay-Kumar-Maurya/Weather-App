      ...
      <nav className="bg-gray-800">
               ...
               <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                  ...
                  <div className="hidden sm:block sm:ml-6">
                     <div className="flex space-x-4">
                        ...
                        <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">World Map</a>
         ...
         <div className="sm:hidden" id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1">
               ...
               <a href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">World Map</a>
